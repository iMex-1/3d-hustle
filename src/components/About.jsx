    ...
    <div className="about-page">
      <section className="about-hero">
        <div className="about-hero-content">
          <h1>À Propos de MDBIM</h1>
          <p>
            Moroccan Design BIM - Votre plateforme de modèles BIM au format IFC
          </p>
        </div>
      </section>
        ...
        <div className="features-grid">
          ...
          >
            ...
            <p>
              Chaque modèle IFC est soigneusement sélectionné et optimisé pour
          ...
          >
            ...
            <h3>Format IFC</h3>
            <p>
              Téléchargez au format IFC pour une compatibilité maximale avec
              tous les logiciels BIM.
            </p>
          </motion.div>
          ...
          >
            ...
            <p>
              Parcourez, prévisualisez et téléchargez avec notre interface
              intuitive et notre visionneuse 3D.
            </p>
          </motion.div>
          ...
          >
            ...
            <p>
              De nouveaux modèles ajoutés régulièrement pour garder vos projets
              BIM à jour.
            </p>
          </motion.div>
        </div>
