    ...
    <div className="min-h-screen flex items-center justify-center bg-background">
        <div className="text-center">
            <div className="relative">
                ...
                <div className="w-12 h-12 mx-auto mb-4 absolute top-2 left-1/2 transform -translate-x-1/2">
                    <div className="absolute inset-0 border-2 border-primary/40 rounded-full animate-pulse"></div>
                </div>
            </div>
...
export const ViewerLoadingFallback = memo(() => (
    <div className="w-full h-full min-h-[400px] bg-card border border-border rounded-lg flex items-center justify-center">
        <div className="text-center">
            ...
            <h3 className="text-lg font-medium text-foreground mb-2">Loading 3D Model</h3>
...
export const DataLoadingFallback = memo(({ progress = 0, message = "Loading data..." }) => (
    <div className="flex items-center justify-center p-8">
...
export const InlineLoadingFallback = memo(({ size = "sm", className = "" }) => {
    ...
    return (
        <div className={`inline-flex items-center ${className}`}>
            <div className={`${sizeClasses[size]} border-2 border-current border-t-transparent rounded-full animate-spin opacity-60`}></div>
        </div>
    );
});

// Button loading state
export const ButtonLoadingFallback = memo(({ children, loading = false, ...props }) => (
...
// Error retry loading
export const RetryLoadingFallback = memo(({ onRetry, message = "Something went wrong" }) => (
